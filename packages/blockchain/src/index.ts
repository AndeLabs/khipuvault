...
const INDIVIDUAL_POOL_ADDRESS = process.env.INDIVIDUAL_POOL_ADDRESS || '0xdfBEd2D3efBD2071fD407bF169b5e5533eA90393'
const COOPERATIVE_POOL_ADDRESS = process.env.COOPERATIVE_POOL_ADDRESS || '0x323FcA9b377fe29B8fc95dDbD9Fe54cea1655F88'
