 ...
 */
export function isValidDepositAmount(amount: string): { valid: boolean; error?: string } {
  try {
 ...
 */
export function isValidWithdrawAmount(amount: string, balance: string): { valid: boolean; error?: string } {
  try {
    const amountBigInt = BigInt(amount)
