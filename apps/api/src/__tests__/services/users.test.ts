...
describe('UsersService', () => {
  ...
  describe('getUserByAddress', () => {
    it('should return user with deposits when user exists', async () => {
      ...
      const result = await usersService.getUserByAddress('0x1234567890123456789012345678901234567890')
    ...
    it('should throw AppError 404 when user does not exist', async () => {
      ...
      await expect(
        usersService.getUserByAddress('0x0000000000000000000000000000000000000000')
    ...
    it('should convert address to lowercase before querying', async () => {
      ...
      await usersService.getUserByAddress('0x1234567890123456789012345678901234567890'.toUpperCase())
  ...
  describe('getUserTransactions', () => {
    ...
    it('should use default limit and offset values', async () => {
      ...
      await usersService.getUserTransactions('0x1234567890123456789012345678901234567890')
  ...
  describe('createOrUpdateUser', () => {
    ...
    it('should update lastActiveAt timestamp on upsert', async () => {
      ...
      await usersService.createOrUpdateUser('0x1234567890123456789012345678901234567890')
  ...
  describe('getUserPortfolio', () => {
    it('should return user portfolio with positions and activity', async () => {
      ...
      const result = await usersService.getUserPortfolio('0x1234567890123456789012345678901234567890')
    ...
    it('should throw AppError 404 when user does not exist', async () => {
      ...
      await expect(
        usersService.getUserPortfolio('0x0000000000000000000000000000000000000000')
      ).rejects.toThrow(AppError)
    })
  })
  ...
  describe('getUserPositions', () => {
    it('should return positions for each pool with balance', async () => {
      ...
      const result = await usersService.getUserPositions('0x1234567890123456789012345678901234567890')
