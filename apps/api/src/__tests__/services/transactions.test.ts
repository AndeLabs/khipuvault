...
import type { Deposit, DepositType, TransactionStatus, PoolType } from '@prisma/client'
...
describe('TransactionsService', () => {
  ...
  describe('getTransactionsByPool', () => {
    it('should return transactions filtered by pool address', async () => {
      ...
      const result = await transactionsService.getTransactionsByPool('0xPOOL1', 10, 0)
