...
import { Trophy, Ticket, Users, Clock, TrendingUp, DollarSign } from 'lucide-react'
...
export function LotteryStats({ roundInfo, isLoading }: LotteryStatsProps) {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: timeRemaining.total > 0
        ? `${timeRemaining.days}d ${timeRemaining.hours}h ${timeRemaining.minutes}m`
        : 'Ended',
      subtitle: roundInfo.status === 0 ? 'Open for entries' : roundInfo.status === 1 ? 'Drawing...' : 'Completed',
      icon: Clock,
