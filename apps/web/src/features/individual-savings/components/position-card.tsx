    ...
    return (
      <Card variant="glass" className={cn("text-center", className)}>
        <CardContent className="py-12">
          ...
          <h3 className="mb-2 text-lg font-semibold">No Active Position</h3>
          <p className="text-muted-foreground">Start earning yields by depositing mUSD</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card variant="surface" hover="glow-lavanda" className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        {/* APY Banner */}
        <div className="bg-gradient-lavanda flex items-center justify-between rounded-lg border border-lavanda/20 p-4">
