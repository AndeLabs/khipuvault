      ...
      <CardContent className="space-y-3">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button type="button" className="text-muted-foreground hover:text-foreground ml-auto">
                        <Info className="h-4 w-4" />
                      </button>
                    </TooltipTrigger>
                    <TooltipContent className="max-w-sm">
                      <p className="font-semibold mb-2">How Auto-Compound Works:</p>
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-sm">
                      ...
                      <div className="space-y-2 text-sm">
                        <p>Yields are the profits generated from your mUSD deposits in Mezo's Stability Pool.</p>
                        <p className="font-medium mt-2">You can either:</p>
                        <div className="flex items-start gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-lavanda mt-1.5" />
                          <span><strong>Claim manually</strong> to receive yields in your wallet</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <div className="h-1.5 w-1.5 rounded-full bg-lavanda mt-1.5" />
                          <span><strong>Enable auto-compound</strong> to automatically reinvest them</span>
                        </div>
                      </div>
                    </TooltipContent>
                  </Tooltip>
        ...
        <div className="flex items-start gap-3 p-3 rounded-lg bg-gradient-lavanda border border-lavanda/20">
          ...
          <div className="flex-1 text-xs text-muted-foreground">
            ...
            <p>
              Enable auto-compound to automatically reinvest yields and benefit from compound interest
            </p>
          </div>
        </div>
      </CardContent>
