    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-heading font-semibold mb-2">Wallet Not Connected</h3>
  ...
  return (
    ...
    >
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>How it works:</strong> Create or join a pool with friends. Each member contributes
          BTC which is deposited into Mezo to generate yields. Yields are distributed proportionally
