...
export default function IndividualSavingsPage() {
  ...
  const minDeposit = Number(formatUnits(BigInt(V3_FEATURES.individualPool.minDeposit), 18)).toString()
    ...
    >
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <YieldAnalytics
            currentAPR={apy}
            currentDeposit={poolData.userInfo?.deposit ? formatUnits(poolData.userInfo.deposit, 18) : "0"}
          />
