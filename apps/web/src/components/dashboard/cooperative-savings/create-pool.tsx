  ...
  return (
    <Card className="bg-card border-primary/20 shadow-custom">
      <CardHeader>
        ...
        <CardDescription>
          Define las reglas y el propósito de tu grupo de ahorro.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Ej: Ahorro Familiar García"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe el propósito de tu pool..."
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <div className="rounded-lg bg-background/50 p-4 border border-primary/20 space-y-2">
              <p className="font-bold text-center">
                💰 Costo de creación: 0.0001 BTC
              </p>
              <p className="text-xs text-muted-foreground text-center">
                Este pequeño fee se usa para prevenir el spam en la red.
              </p>
            </div>
