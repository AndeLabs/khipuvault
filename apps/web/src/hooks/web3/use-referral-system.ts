...
export function useReferralSystem() {
  ...
  return {
    ...
    hasReferrer: referralStats ? referralStats.referrer !== '0x0000000000000000000000000000000000000000' : false,
    loadingStats,
    ...
    canClaim: (state === 'idle' || state === 'error' || state === 'success') && referralStats && referralStats.rewards > 0n,
  }
}
