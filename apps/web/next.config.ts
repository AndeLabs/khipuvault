        ...
        headers: [
          ...
          // Content Security Policy - Allow wallet connections and essential resources
          {
            ...
            value: [
              ...
              `connect-src 'self' ${process.env.NEXT_PUBLIC_API_URL || "https://khipuvault.onrender.com"} http://localhost:3001 http://127.0.0.1:3001 https://rpc.test.mezo.org https://rpc.mezo.org wss://rpc.test.mezo.org wss://rpc.mezo.org https://*.mezo.boar.network wss://*.mezo.boar.network https://explorer.test.mezo.org https://api.coingecko.com https://*.metamask.io https://*.cx.metamask.io https://mm-sdk-analytics.api.cx.metamask.io https://mm-sdk.metamask.io`,
