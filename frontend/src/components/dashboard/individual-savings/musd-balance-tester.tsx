...
export function MusdBalanceTester() {
  ...
  const fetchDirectBalance = async () => {
    ...
    try {
      console.log('🔍 Fetching MUSD balance directly with viem publicClient...')
    ...
    <Card className="bg-card border border-green-500/50">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-green-500">🧪 Test Directo con Viem</CardTitle>
          <Button
            variant="ghost"
            size="sm"
      ...
      <CardContent className="space-y-4">
        <div className="text-xs font-mono space-y-2">
          <p className="text-muted-foreground">Lectura directa con viem publicClient:</p>
          ...
          {error && (
            <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/30">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-red-500 font-semibold text-xs">Error al consultar balance:</p>
            ...
            <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/30">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 space-y-1">
                  <p className="text-green-500 font-semibold">✅ Balance obtenido exitosamente</p>
                  <div className="space-y-1">
                    <p className="text-white">
                      <span className="text-muted-foreground">Raw Wei:</span> {directBalance.toString()}
                    </p>
          ...
          <div className="pt-2 border-t border-green-500/30">
            ...
            <p className="text-muted-foreground text-xs">
              Si este test muestra el balance correcto pero Wagmi muestra 0, 
              el problema está en la configuración de Wagmi o en el cache de React Query.
            </p>
          </div>
        </div>
      </CardContent>
