...
export default function NotificationsPage() {
    const notificationCategories = [
        ...
        },
        {
            ...
            items: ["Tu turno de pagar", "Tu turno de recibir", "Cambios en la tanda", "Miembros sin pagar"],
        },
        {
                ...
                <CardContent className="space-y-6">
                    <div className="flex items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                            <Label htmlFor="push-notifications" className="text-base">Activar Notificaciones Push</Label>
                        ...
                        <h3 className="font-semibold">Frecuencia de Resúmenes por Email</h3>
                         <RadioGroup defaultValue="daily" className="flex flex-col md:flex-row gap-4">
                            <div>
                                ...
                                <Label htmlFor="realtime" className="ml-2">Tiempo Real</Label>
                            </div>
                            <div>
                                <RadioGroupItem value="daily" id="daily" />
                                <Label htmlFor="daily" className="ml-2">Diario</Label>
                            </div>
                            <div>
                                <RadioGroupItem value="weekly" id="weekly" />
                                <Label htmlFor="weekly" className="ml-2">Semanal</Label>
                            </div>
                        </RadioGroup>
                    </div>
